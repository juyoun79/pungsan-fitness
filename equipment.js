  ...
  const FW_EXERCISE_LIST = [
    ...
    { name: '바벨 힙 쓰러스트',          category: '바벨', muscles: '엉덩이' },
    ...
    { name: '해머 컬',                   category: '덤벨', muscles: '이두' },
    ...
    { name: '덤벨 힙 쓰러스트',          category: '덤벨', muscles: '엉덩이' },
    ...
    { name: '딥스',                      category: '맨몸', muscles: '삼두' },
    { name: '스쿼트',                    category: '맨몸', muscles: '하체' },
    { name: '런지',                      category: '맨몸', muscles: '하체' },
    { name: '플랭크',                    category: '맨몸', muscles: '코어' },
    { name: '버피',                      category: '맨몸', muscles: '전신' },
    { name: '크런치',                    category: '맨몸', muscles: '복부' },
    { name: '레그 레이즈',               category: '맨몸', muscles: '복부' },
    { name: '마운틴 클라이머',           category: '맨몸', muscles: '코어' },
    { name: '데드버그',                  category: '맨몸', muscles: '코어' },
    { name: '버드독',                    category: '맨몸', muscles: '코어' },
    { name: '스플릿 스쿼트',             category: '맨몸', muscles: '하체' },
    { name: '힙 쓰러스트',               category: '맨몸', muscles: '엉덩이' },
    { name: '사이드 플랭크',             category: '맨몸', muscles: '코어' },
    { name: '불가리안 스쿼트',           category: '맨몸', muscles: '하체' },
    { name: '리버스 런지',               category: '맨몸', muscles: '하체' },
    { name: '와이드 스쿼트',             category: '맨몸', muscles: '하체' },
    { name: '힙 브릿지',                 category: '맨몸', muscles: '엉덩이' },
    ...
    { name: '행잉 레그레이즈',           category: '맨몸', muscles: '복부' },
    // 종아리 운동 추가
