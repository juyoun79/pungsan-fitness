  ...
  const FW_EXERCISE_LIST = [
    // 바벨 운동
    { name: '바벨 벤치프레스',           category: '바벨', muscles: '가슴' },
    { name: '바벨 백스쿼트',             category: '바벨', muscles: '하체' },
    { name: '바벨 프론트스쿼트',         category: '바벨', muscles: '하체' },
    { name: '바벨 벤트오버 로우',        category: '바벨', muscles: '등' },
    { name: '바벨 오버헤드프레스',       category: '바벨', muscles: '어깨' },
    { name: '바벨 런지',                 category: '바벨', muscles: '하체' },
    { name: '바벨 컬',                   category: '바벨', muscles: '팔 · 이두' },
    { name: '루마니안 데드리프트',       category: '바벨', muscles: '하체' },
    { name: '컨벤셔널 데드리프트',       category: '바벨', muscles: '하체' },
    { name: '스모 데드리프트',           category: '바벨', muscles: '하체' },
    { name: '라잉 트라이셉스 익스텐션', category: '바벨', muscles: '팔 · 삼두' },
    { name: '스플릿 스쿼트',             category: '바벨', muscles: '하체' },
    { name: '바벨 힙 쓰러스트',          category: '바벨', muscles: '하체' },
    { name: '바벨 굿모닝',               category: '바벨', muscles: '하체' },
    { name: '바벨 업라이트 로우',        category: '바벨', muscles: '어깨' },
    { name: '클로즈그립 벤치프레스',     category: '바벨', muscles: '가슴' },
    { name: '바벨 쉬러그',               category: '바벨', muscles: '승모근' },
    // 덤벨 운동
    { name: '덤벨 벤치프레스',           category: '덤벨', muscles: '가슴' },
    { name: '덤벨 플라이',               category: '덤벨', muscles: '가슴' },
    { name: '덤벨 숄더프레스',           category: '덤벨', muscles: '어깨' },
    { name: '덤벨 레터럴 레이즈',        category: '덤벨', muscles: '어깨' },
    { name: '덤벨 프론트 레이즈',        category: '덤벨', muscles: '어깨' },
    { name: '덤벨 벤트오버 로우',        category: '덤벨', muscles: '등' },
    { name: '덤벨 컬',                   category: '덤벨', muscles: '팔 · 이두' },
    { name: '해머 컬',                   category: '덤벨', muscles: '팔 · 이두' },
    { name: '덤벨 트라이셉스 익스텐션', category: '덤벨', muscles: '팔 · 삼두' },
    { name: '덤벨 런지',                 category: '덤벨', muscles: '하체' },
    { name: '덤벨 스쿼트',               category: '덤벨', muscles: '하체' },
    { name: '덤벨 데드리프트',           category: '덤벨', muscles: '등' },
    ...
    { name: '덤벨 스플릿 스쿼트',        category: '덤벨', muscles: '하체' },
    // 맨몸 운동
    { name: '푸시업',                    category: '맨몸', muscles: '가슴' },
    { name: '풀업',                      category: '맨몸', muscles: '등' },
    { name: '친업',                      category: '맨몸', muscles: '등' },
    { name: '딥스',                      category: '맨몸', muscles: '팔 · 삼두' },
    { name: '스쿼트',                    category: '맨몸', muscles: '하체' },
    { name: '런지',                      category: '맨몸', muscles: '하체' },
    { name: '플랭크',                    category: '맨몸', muscles: '코어/복부' },
    { name: '버피',                      category: '맨몸', muscles: '전신' },
    { name: '크런치',                    category: '맨몸', muscles: '코어/복부' },
    { name: '레그 레이즈',               category: '맨몸', muscles: '코어/복부' },
    { name: '마운틴 클라이머',           category: '맨몸', muscles: '코어/복부' },
    { name: '데드버그',                  category: '맨몸', muscles: '코어/복부' },
    { name: '버드독',                    category: '맨몸', muscles: '코어/복부' },
    { name: '스플릿 스쿼트',             category: '맨몸', muscles: '하체' },
    { name: '힙 쓰러스트',               category: '맨몸', muscles: '하체' },
    { name: '사이드 플랭크',             category: '맨몸', muscles: '코어/복부' },
    { name: '불가리안 스쿼트',           category: '맨몸', muscles: '하체' },
    { name: '리버스 런지',               category: '맨몸', muscles: '하체' },
    { name: '와이드 스쿼트',             category: '맨몸', muscles: '하체' },
    { name: '힙 브릿지',                 category: '맨몸', muscles: '하체' },
    { name: '싱글 레그 힙힌지',          category: '맨몸', muscles: '하체' },
    // 덤벨 추가
    { name: '싱글 레그 데드리프트',      category: '덤벨', muscles: '하체' },
    // 추가 운동
    { name: '덤벨 인클라인 벤치프레스',  category: '덤벨', muscles: '가슴' },
    { name: '덤벨 인클라인 플라이',      category: '덤벨', muscles: '가슴' },
    { name: '원암 덤벨 로우',            category: '덤벨', muscles: '등' },
    { name: '아놀드 프레스',             category: '덤벨', muscles: '어깨' },
    { name: '행잉 레그레이즈',           category: '맨몸', muscles: '코어/복부' },
    // 종아리 운동 추가
    { name: '스탠딩 카프 레이즈',        category: '맨몸', muscles: '종아리' },
    { name: '싱글 레그 카프 레이즈',     category: '맨몸', muscles: '종아리' },
    { name: '덤벨 카프 레이즈',          category: '덤벨', muscles: '종아리' },
    { name: '시티드 카프 레이즈',        category: '덤벨', muscles: '종아리' },
  ];
